...
class MultiheadAttention(FairseqIncrementalDecoder):
    ...
    def __init__(
        ...
        if 'key' in cooperative_modules:
            self.k_proj = quant_noise(
                CooperativeLinear(self.kdim, embed_dim, num_experts=num_experts, bias=bias), q_noise, qn_block_size
            )
        else:
            self.k_proj = quant_noise(
        ...
        if 'value' in cooperative_modules:
            self.v_proj = quant_noise(
                CooperativeLinear(self.vdim, embed_dim, num_experts=num_experts, bias=bias), q_noise, qn_block_size
            )
        else:
            self.v_proj = quant_noise(
        ...
        if 'query' in cooperative_modules:
            self.q_proj = quant_noise(
                CooperativeLinear(embed_dim, embed_dim, num_experts=num_experts, bias=bias), q_noise, qn_block_size
            )
        else:
            self.q_proj = quant_noise(
        ...
        if 'attention_out' in cooperative_modules:
