...
do
for sample_period in 8 64 512
do
TF_CPP_MIN_LOG_LEVEL=2 TF_ENABLE_ONEDNN_OPTS=0 WANDB_PROJECT='T5-Analysis' CUDA_VISIBLE_DEVICES=2 python examples/text-classification/run_glue.py \
