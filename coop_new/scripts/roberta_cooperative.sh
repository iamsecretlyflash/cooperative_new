...
eval_st=(115 268 156 170 295)
batch=(32 32 16 32 32)
num_experts=4
learn_rate=(5e-5 2e-5 3e-5 3e-5 3e-5)
sample_period=1
max_seq_length=128
vls=5e-3
kl_loss_weight=1e-5
...
--report_to wandb \
--seed 6  \
--output_dir ../outputs/roberta/${task}/query/posthoc/${num_epochs}/${num_coop_epochs}/${vls}/${lr}/${num_experts} \
