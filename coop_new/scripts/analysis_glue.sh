...
bs=32
max_seq_length=128
for max_seq_length in 128 512 1024 2048
do
TF_CPP_MIN_LOG_LEVEL=2 TF_ENABLE_ONEDNN_OPTS=0 WANDB_PROJECT='T5-Base-Analysis' CUDA_VISIBLE_DEVICES=2 python examples/text-classification/run_glue_debug.py \
...
--num_train_epochs 10 \
--evaluation_strategy steps --eval_steps 29  \
