...
bs="${batch[$i]}"
lr="${learn_rate[$i]}"
TF_CPP_MIN_LOG_LEVEL=2 TF_ENABLE_ONEDNN_OPTS=0 WANDB_PROJECT='Deberta-Cooperative-PostHoc' CUDA_VISIBLE_DEVICES=0 python /home/vaibhav/Untitled/examples/text-classification/run_glue.py \
