...
class Trainer:
    ...
    def _inner_training_loop(
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            step = -1
            print(f'Layer {12}')
            if 'query' in model.config.expert_locations.split(','):
                print('Query Sum: ',model._modules['bert']._modules['encoder']._modules['layer']._modules[str(11)]._modules['attention']._modules['self']._modules['query']._parameters['logvar'].sum())
                print('Query Random Values: ',model._modules['bert']._modules['encoder']._modules['layer']._modules[str(11)]._modules['attention']._modules['self']._modules['query']._parameters['logvar'][0:5])
                print('Query Expert Weights: ',model._modules['bert']._modules['encoder']._modules['layer']._modules[str(11)]._modules['attention']._modules['self']._modules['query']._parameters['expert_weights'])
            if 'key' in model.config.expert_locations.split(','):
                print('Key Norm: ',model._modules['bert']._modules['encoder']._modules['layer']._modules[str(11)]._modules['attention']._modules['self']._modules['key']._parameters['logvar'].norm())
                print('Key Expert Weights: ',model._modules['bert']._modules['encoder']._modules['layer']._modules[str(11)]._modules['attention']._modules['self']._modules['key']._parameters['expert_weights'])
            if 'value' in model.config.expert_locations.split(','):
                print('Value Norm: ',model._modules['bert']._modules['encoder']._modules['layer']._modules[str(11)]._modules['attention']._modules['self']._modules['value']._parameters['logvar'].norm())
                print('Value Expert Weights: ',model._modules['bert']._modules['encoder']._modules['layer']._modules[str(11)]._modules['attention']._modules['self']._modules['value']._parameters['expert_weights'])
            if 'attention_out' in model.config.expert_locations.split(','):
                print('Sum: ',model._modules['bert']._modules['encoder']._modules['layer']._modules[str(11)]._modules['attention']._modules['output']._modules['dense']._parameters['logvar'].sum())
                print('Weights: ',model._modules['bert']._modules['encoder']._modules['layer']._modules[str(11)]._modules['attention']._modules['output']._modules['dense']._parameters['expert_weights'])
            if 'output' in model.config.expert_locations.split(','):
                print('Sum: ',model._modules['bert']._modules['encoder']._modules['layer']._modules[str(11)]._modules['output']._modules['dense']._parameters['logvar'].sum())
                print('Weights: ',model._modules['bert']._modules['encoder']._modules['layer']._modules[str(11)]._modules['output']._modules['dense']._parameters['expert_weights'])
            if 'intermediate' in model.config.expert_locations.split(','):
                print('Sum: ',model._modules['bert']._modules['encoder']._modules['layer']._modules[str(11)]._modules['intermediate']._modules['dense']._parameters['logvar'].sum())
                print('Weights: ',model._modules['bert']._modules['encoder']._modules['layer']._modules[str(11)]._modules['intermediate']._modules['dense']._parameters['expert_weights'])
    ...
    def training_step(self, model: nn.Module, inputs: Dict[str, Union[torch.Tensor, Any]]) -> torch.Tensor:
        ...
        if model.config.num_experts:
            var_loss = 0
            model_name = list(model._modules.keys())[0]
            locations = model.config.expert_locations
            for layer_num in range (model.config.num_hidden_layers):
                    if 'query' in locations:
                        var_loss += model._modules[model_name].encoder.layer[layer_num].attention.self.query.return_variational_loss()
                    if 'key' in locations:
                        var_loss += model._modules[model_name].encoder.layer[layer_num].attention.self.key.return_variational_loss()
                    if 'value' in locations:
                        var_loss += model._modules[model_name].encoder.layer[layer_num].attention.self.value.return_variational_loss()
                    if 'attention_out' in locations:
                        var_loss += model._modules[model_name].encoder.layer[layer_num].attention.output.dense.return_variational_loss()
                    if 'intermediate' in locations:
                        var_loss += model._modules[model_name].encoder.layer[layer_num].intermediate.dense.return_variational_loss()
                    if 'output' in locations:
                        var_loss += model._modules[model_name].encoder.layer[layer_num].output.dense.return_variational_loss()
            loss += var_loss
    ...
    def evaluation_loop(
        ...
        if all_losses is not None:
            ...
            print ("Eval loss is nan")
            metrics[f"{metric_key_prefix}_loss"] = 0
