...
class TrainingArguments:
    ...
    recovery_steps: int = field(
        default=100,
        metadata={"help": "Number of recovery steps"},
    )
    ...
    num_coop_epochs: float = field(default=0.0, metadata={"help": "Total number of cooperative training epochs to perform."})
    num_std_epochs: float = field(default=3.0, metadata={"help": "Total number of standard training epochs to perform."})
    max_steps: int = field(
        default=-1,
